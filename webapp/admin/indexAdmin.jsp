		...
		<nav class="navbar navbar-expand-sm navbar-default">
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="nav-item active"><a href="/pc06165-asm/admin/homeAdmin"
						class="nav-link"><i class="menu-icon fa fa-home"
							aria-hidden="true"></i>HOME</a></li>
					<!-- <li class="menu-title">YOU</li> -->
					<!-- /.menu-title -->
					<li class="nav-item"><a href="${url}admin/videoMangement"
					...
					<li class="nav-item menu-item-has-children dropdown">
						...
						<ul class="sub-menu children dropdown-menu">
							<li>
								...
								<a href="/pc06165-asm/admin/favorites">FAVORITES</a>
							</li>
							<li>
								<i class="menu-icon fa fa-registered" aria-hidden="true"></i>
								<a href="/pc06165-asm/admin/favoriteUser">FAVORITE USERS</a>
							</li>
							<li>
								<i class="menu-icon fa fa-sign-in" aria-hidden="true"></i>								
								<a href="/pc06165-asm/admin/sharefriend">SHARE FRIENDS</a>
							</li>
						</ul>
					</li>
				...
				<div class="header-menu">
					...
					<div class="user-area dropdown float-right">
						<a href="#" class="dropdown-toggle active" data-toggle="dropdown"
							...
							class="user-avatar rounded-circle" src="${url}images/pandaLogo2.png"
							alt="User Avatar">
						</a>
