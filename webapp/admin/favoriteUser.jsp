...
<body>
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="nav-item active"><a href="index.jsp"
						class="nav-link"><i class="menu-icon fa fa-home"
							aria-hidden="true"></i>HOME</a></li>
					<!-- <li class="menu-title">YOU</li> -->
					<!-- /.menu-title -->
					<li class="nav-item"><a href="videoManagement.jsp"
						class="nav-link"><i class="menu-icon fa fa-thumbs-o-up"
							aria-hidden="true"></i>VIDEOS</a></li>
					<li class="nav-item"><a href="userManagement.jsp"
						class="nav-link"><i class="menu-icon fa fa-thumbs-o-up"
							aria-hidden="true"></i>USERS</a></li>
					<!-- <li class="nav-item"><a href="#" class="nav-link"> <i
							class="menu-icon fa fa-history" aria-hidden="true"></i>LỊCH SỬ
					</a></li> -->
					...
					<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li>
								<i class="menu-icon fa fa-registered" aria-hidden="true"></i>
								<a href="favoriteUser.jsp">FAVORITE USERS</a>
							</li>
							<li>
								<i class="menu-icon fa fa-sign-in" aria-hidden="true"></i>								
								<a href="shareFriend.jsp">SHARE FRIENDS</a>
							</li>
						</ul>
					</li>
			...
			<div class="top-left">
				<div class="navbar-header">
					<a class="navbar-brand" href="./"><img
						...
						src="${url}images/pandaLogo2.png" alt="Logo"></a> <a id="menuToggle"
				...
				<div class="header-menu">
					...
					<div class="user-area dropdown float-right">
						<a href="#" class="dropdown-toggle active" data-toggle="dropdown"
							...
							class="user-avatar rounded-circle" src="images/pandaLogo2.png"
							alt="User Avatar">
						</a>
				...
				<div class="orders">
					<div class="row">
						<div class="">
							<div class="card">
								<div class="card-body">
									<h4 class="box-title">FAVORITE USERS</h4>
								</div>
								<div class="card-body--">
									<form action="${url}admin/favoriteUser/findVideoByUser" method="POST">
										<div class="form-group">
											<div class="input-group">
												<input value="${user.idUser}" type="text" id="idUser" name="idUser"
									...
									<div class="table-stats order-table ov-h">
										<table class="table ">
											...
											<c:forEach var="item" items="${favorites}">
												<tr>
													<td>${item.user.idUser}</td>
													<td>${item.user.fullnameUser}</td>
													<td>${item.user.emailUser}</td>
													<td>${item.likeDate}</td>
												</tr>												
											</c:forEach>
											</tbody>
	...
	<script src="https://kit.fontawesome.com/bbb142e52e.js" crossorigin="anonymous"></script>
